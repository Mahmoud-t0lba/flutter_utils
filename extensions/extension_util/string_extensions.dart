...
extension StringExtension on String? {
  ...
  String capitalizedByWord() {
    String word = validate();
    var capitalizedString = word
        .replaceAll(RegExp(' +'), ' ')
        .split(' ')
        .map((capitalizedString) => capitalizedString.substring(0, 1).toUpperCase() + capitalizedString.substring(1))
        .join(' ');
...
//print(s.capitalize());
//print(s.capitalizeFirstLetter());
//print(s.toSlug());
//print(s.toSlug(delimiter: '-'));
//print(s.toSlug(delimiter: '_'));
//print(s.countWords());
//print(s.calculateReadTime());
//print(s.calculateReadTime(wordsPerMinute: 100));
//print(s.getNumericOnly());
//print(s.getNumericOnly(aFirstWordOnly: true));
//print(s.renderHtml);
//print(s.toYouTubeId());
//print(s.toYouTubeId(trimWhitespaces: false));
//print(s.getYouTubeThumbnail());
//print(s.getYouTubeThumbnail(trimWhitespaces: false));
//print(s.splitAfter(RegExp(r'(\s+)')));
//print(s.splitBefore(RegExp(r'(\s+)')));
//print(s.splitBetween(RegExp(r'(\s+)'), RegExp(r'(\s+)')));
//print(s.splitBetween(RegExp(r'(\s+)'), RegExp(r'(\s+)')));
//print(s.removeHtmlTags());
//print(s.removeHtmlTags(allowableTags: ['b']));
//print(s.removeHtmlTags(allowableTags: ['b', 'i']));
//print(s.removeHtmlTags(allowableTags: ['b', 'i'], removeWhitespace: false));
//print(s.removeHtmlTags(allowableTags: ['b', 'i'], removeWhitespace: true));
//print(s.removeHtmlTags(allowableTags: ['b', 'i'], removeWhitespace: true, removeNewLines: false));
