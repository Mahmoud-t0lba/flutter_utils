...
//int number = 10;
//print(number.toMonthName()); // October
//print(number.toMonthName(isHalfName: true)); // Oct
//print(number.toMonthDaySuffix()); // 10th

//int number2 = 1;
//print(number2.toWeekDay()); // Monday
//print(number2.toWeekDay(isHalfName: true)); // Mon
